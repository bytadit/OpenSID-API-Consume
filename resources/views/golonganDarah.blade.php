...
<body>
            ...
            <div class="flex justify-between items-center gap-x-8">
                ...
                <div id="dropdown" class="hidden w-44 bg-white rounded divide-y divide-gray-100 shadow-md dark:bg-gray-700 border-t-2 border-indigo-600">
                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                        ...
                        <li>
                            <a href="/calonpemilih" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Calon Pemilih</a>
                        </li>
                        <li>
                ...
                <a href="/login" class="w-auto rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                    Keluar
                </a>
            </div>
        </div>
    ...
    <div class="rounded-md mt-5 mx-auto max-w-5xl">
        <ol class="list-reset flex">
            ...
            <li class="text-gray-500">Golongan Darah</li>
        </ol>
    </div>
    ...
    <section class="mt-2 mx-auto h-96 overflow-auto rounded-md max-w-5xl shadow-sm">
